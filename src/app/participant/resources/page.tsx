  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <Image
        ...
        alt="Pink Squiggly"
        fill
        className="pointer-events-none opacity-0 md:mt-[500px] md:opacity-100 lg:mt-[460px] xl:mt-[390px] 2xl:mt-52"
      />
      <Image
        src="/svgs/resources/orangeSquiggly.svg"
        alt="Orange Squiggly"
        fill
        className="pointer-events-none rotate-180 opacity-0 md:mt-[650px] md:opacity-100 lg:mt-[680px] xl:mt-[580px] 2xl:mt-[430px]"
      />
