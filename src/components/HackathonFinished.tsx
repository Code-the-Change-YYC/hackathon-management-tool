...
const HackathonFinished = () => {
  return (
    <div className="min-h-screen w-full bg-[url(/images/landingpage/HackathonFinished/hackathon_finished_background.png)] bg-cover bg-center">
      <div className="flex h-screen items-center justify-center">
        <div className="flex -translate-y-16 flex-col items-center gap-1.5">
          <img className="mb-4" src="/CTCLogo.svg" />
          ...
          <div>
            <p className="rounded-full bg-white px-6 py-3 text-2xl italic text-[#4B486D] shadow-md">
