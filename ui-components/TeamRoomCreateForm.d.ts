...
export declare type TeamRoomCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: TeamRoomCreateFormInputValues) => TeamRoomCreateFormInputValues;
    onSuccess?: (fields: TeamRoomCreateFormInputValues) => void;
    onError?: (fields: TeamRoomCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: TeamRoomCreateFormInputValues) => TeamRoomCreateFormInputValues;
    onValidate?: TeamRoomCreateFormValidationValues;
} & React.CSSProperties>;
export default function TeamRoomCreateForm(props: TeamRoomCreateFormProps): React.ReactElement;
