...
export declare type TeamRoomUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    teamRoom?: TeamRoom;
    onSubmit?: (fields: TeamRoomUpdateFormInputValues) => TeamRoomUpdateFormInputValues;
    onSuccess?: (fields: TeamRoomUpdateFormInputValues) => void;
    onError?: (fields: TeamRoomUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: TeamRoomUpdateFormInputValues) => TeamRoomUpdateFormInputValues;
    onValidate?: TeamRoomUpdateFormValidationValues;
} & React.CSSProperties>;
export default function TeamRoomUpdateForm(props: TeamRoomUpdateFormProps): React.ReactElement;
