...
import { createTeamRoom } from "./graphql/mutations";
const client = generateClient();
export default function TeamRoomCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setZoomLink(initialValues.zoomLink);
    setErrors({});
  };
  const validations = {
    time: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createTeamRoom.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "TeamRoomCreateForm")}
      {...rest}
    >
      <TextField
        label="Time"
